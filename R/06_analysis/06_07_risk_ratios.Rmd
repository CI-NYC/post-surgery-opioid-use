...
write.csv(result_df, "~/medicaid/post_surgery_opioid_use/R/06_analysis/c-section_RD_and_RR.csv", row.names = F)
...
write.csv(result_df, "~/medicaid/post_surgery_opioid_use/R/06_analysis/other_RD_and_RR.csv", row.names = F)
