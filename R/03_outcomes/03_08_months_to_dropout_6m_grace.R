...
cohort$enrolled_until <- as.Date(sapply(1:nrow(cohort), function(i) {
  ...
  q2 <- (last_enrollment_end + days(182)) >= enrollment_date
...
saveRDS(cohort, "/mnt/general-data/disability/post_surgery_opioid_use/outcomes/cohort_months_to_dropout_6m_grace.rds")
...
cohort <- readRDS("/mnt/general-data/disability/post_surgery_opioid_use/outcomes/cohort_months_to_dropout_6m_grace.rds")
