...
load_dir <- "/mnt/general-data/disability/post_surgery_opioid_use/analysis/earth"
result_dir <- "/mnt/general-data/disability/post_surgery_opioid_use/analysis/earth/plots"
