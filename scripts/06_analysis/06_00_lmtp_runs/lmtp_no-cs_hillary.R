...
library(lmtp)
# library(devtools)
# load_all("~/libs/lmtp-mlr3superlearner")
library(tictoc)
library(tidyverse)
library(lubridate)
library(mlr3)
...
# dat_only_c_section <- dat_only_c_section[50000:51000,]

# dat_non_c_section <- dat_non_c_section[50000:51000,]
...
run_lmtp <- function(dat_lmtp, W, c_section_identifier) {
  ...
  for (Y in Ys){
    # results_observ <- readRDS(file.path("/mnt/general-data/disability/post_surgery_opioid_use/analysis", version,
