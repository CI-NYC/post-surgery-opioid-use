...
conversion_table <- read.table(file = "/Users/anton/Library/CloudStorage/OneDrive-ColumbiaUniversityIrvingMedicalCenter/Q1_2024/lisa/ICD conversions/gem_i9pcs.txt")
