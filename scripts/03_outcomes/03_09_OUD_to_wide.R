...
censoring <- load_data(paste0("pain_washout_continuous_enrollment_censoring.fst"), file.path(drv_root, "outcomes"))
...
###### UNCOMMENT BOTTOM PORTION IF NEEDED
