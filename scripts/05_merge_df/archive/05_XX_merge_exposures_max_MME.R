...
mme <- readRDS(file.path(opioid_dir, "surgery_max_daily_dose_mme_truncated.rds"))
...
saveRDS(cohort, "/mnt/general-data/disability/post_surgery_opioid_use/final/exposures_merged_max.rds")
