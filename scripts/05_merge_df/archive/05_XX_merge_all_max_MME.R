...
exposures <- readRDS("/mnt/general-data/disability/post_surgery_opioid_use/final/exposures_merged_max.rds")
...
saveRDS(combined_df_1, "/mnt/general-data/disability/post_surgery_opioid_use/final/df_non_c_section_max.rds")
saveRDS(combined_df_2, "/mnt/general-data/disability/post_surgery_opioid_use/final/df_only_c_section_max.rds")
